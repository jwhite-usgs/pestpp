...
int main(int argc, char* argv[])
{
	...
	try
	{
		...
		cout << endl << endl;
		cout << "             pestpp-sqp: industrial strength constrained non-linear optimization under uncertainty" << endl << endl;
		cout << "             (if you don't know, now you know...)" << endl;
		...
		if (argc >= 2) {
			...
			cerr << "        pestpp-sqp control_file.pst" << endl << endl;
			cerr << "    PANTHER master:" << endl;
			cerr << "        pestpp-sqp control_file.pst /H :port" << endl << endl;
			cerr << "    PANTHER worker:" << endl;
			cerr << "        pestpp-sqp control_file.pst /H hostname:port " << endl << endl;
		...
		{
			fout_rec << "             pestpp-sqp: industrial strength constrained non-linear optimization under uncertainty" << endl << endl;
			fout_rec << "                (if you don't know, now you know...)" << endl;
		...
		SeqQuadProg sqp(pest_scenario, file_manager, output_file_writer, &performance_log, run_manager_ptr);
